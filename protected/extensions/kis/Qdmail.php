...
EOF;
	...
	function & smtpObject( $null = false ){
		...
		//$this->smtp_object = & new Qdsmtp();//110830
...
class QdmailComponent extends QdmailUserFunc{
	...
	function & smtpObject(){
		...
		//$this->Qdsmtp = & new QdsmtpComponent();//110830
	...
	function cakeRender( $content , $type , $org_charset = null , $target_charset = null){
		...
		$type = strtolower( $type );
		//$view = & new $this->Controller->view( $this->Controller , false );//110830
